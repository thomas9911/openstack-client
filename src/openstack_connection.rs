...
impl OpenstackConnection{
    pub fn new() -> OpenstackConnection{
        OpenstackConnection{}
    }

    pub fn delete(res: OSResource) {

    }
    pub fn list(res: OSResource) {

    }
    pub fn get(res: OSResource, id: String) {

    }
    pub fn update(res: OSResource, id: String) {
